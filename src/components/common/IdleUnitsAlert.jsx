...
const IdleUnitsAlert = ({ markersData, onUnitSelect }) => {
  ...
  return (
    <BaseExpandableAlert
      ...
      verticalOffset={{ desktop: 530, mobile: 480 }} // Cuando hay unidades seleccionadas
      noUnitsOffset={{ desktop: 200, mobile: 240 }} // Cuando NO hay unidades seleccionadas - posición inferior
      onUnitSelect={handleUnitSelect}
